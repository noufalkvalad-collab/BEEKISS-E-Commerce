...
export default function LoginPage() {
    ...
    return (
        <main className="min-h-screen bg-[#0F2E1D] flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="bg-white p-10 md:p-16 rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] max-w-md w-full text-center relative z-10 opacity-0 animate-[fadeInUp_0.8s_ease-out_forwards]">
                {/* Brand Logo Mini */}
                <div className="w-14 h-14 mx-auto relative mb-8">
                ...
                <h1 className="text-4xl font-serif font-bold text-[#0F2E1D] mb-4">
                    Welcome Back
                </h1>

                <p className="text-gray-600 mb-10 font-sans leading-relaxed text-sm">
                    Sign in to your Bee Kiss account to manage your premium honey orders and save your preferences.
                </p>

                <button
                    onClick={() => signIn('google', { callbackUrl: '/' })}
                    className="w-full bg-[#D4A017] text-[#0F2E1D] font-bold py-4 px-6 rounded-xl flex items-center justify-center gap-4 hover:bg-[#b88a10] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 font-sans text-lg group"
                >
